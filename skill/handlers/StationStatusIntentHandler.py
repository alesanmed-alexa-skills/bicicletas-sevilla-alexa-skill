...
class StationStatusIntentHandler(AbstractRequestHandler):
    """Handler for Get New Question Intent."""
    def can_handle(self, handler_input):
        # type: (HandlerInput) -> bool

        return is_intent_name("StationStatusIntent")(handler_input)
    ...
    def handle(self, handler_input):
        ...
        logger.get_logger().info('Station status ended')
